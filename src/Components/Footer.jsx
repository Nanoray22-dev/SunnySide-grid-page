...
function Footer() {
  return (
    ...
    <div className="text-xl text-black">
        <p>Chanllenge by <a className="text-[#3e52a3] font-Barlow" href="https://www.frontendmentor.io/challenges" >Frontend Mentor</a>. Code by<a className="text-[#3e52a3] font-Barlow" href=""> Raysell</a>. </p>
    </div>
    </footer>
